...
import (
	...
	"github.com/YCJE/XPanel/config"
	"github.com/YCJE/XPanel/logger"
	"github.com/YCJE/XPanel/util/common"
	"github.com/YCJE/XPanel/web/controller"
	"github.com/YCJE/XPanel/web/job"
	"github.com/YCJE/XPanel/web/locale"
...
// Server represents the main web server for the XPanel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("xpanel", store))
